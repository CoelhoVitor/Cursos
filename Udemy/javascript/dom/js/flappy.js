...
function Passaro(alturaJogo) {
  ...
  this.animar = () => {
    ...
    const alturaMaxima = alturaJogo - this.width
...
function Progresso() {
  ...
  // this.notificarPonto = () => {
  //   this.atualizarPontos(10)
  // }
}

// const progresso = new Progresso()
// const barreiras = new criaBarreiras(700, 1200, 350, 400)
...
function FlappyBird() {
  ...
  const progresso = new Progresso()
  const barreiras = new criaBarreiras(altura, largura, 350, 400,
